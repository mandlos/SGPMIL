...
class probabilistic_MIL_Bayes_spvis(nn.Module):
    def __init__(self, gate=True, size_arg="small", dropout=False, encoder:str='univ1', patch_size:int=224, n_classes=2, top_k=1):
        ...
        self.prior_mu = torch.tensor([3.]).expand(n_classes)
        self.prior_logvar = torch.tensor([5.]).expand(n_classes)
