...
import numpy as np
from dgr_utils.multiheadatt import MultiheadLinearAttention
...
class DGRMIL(nn.Module):
    ...
    def forward(self, x, bag_mode='normal'):
        ...
        return {"cls":cls, "A":A, "H":H, "p_center":self.postivecenter, "nc_center":self.normalcenter, "lesion":lesion_enhacing}
        # else: 
        #     # cls = self.classifier(out)
        #     # #cls = cls.squeeze(0)
